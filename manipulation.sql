...
-- Emplyee pode apenas selecionar os dados
GRANT SELECT ON *.* TO employee;

-- Client pode apenas executar uma procedure chamada "insertData"
GRANT EXECUTE ON PROCEDURE insertData TO patient;
...
GRANT employee TO 'andre.souza'@'localhost';
GRANT manager TO 'bruno.miglioretto'@'localhost';
GRANT admin TO 'gustavo.takahashi'@'localhost';
GRANT client TO 'nicolas.zamprogno'@'localhost';
GRANT patient TO 'user.teste'@'localhost';
